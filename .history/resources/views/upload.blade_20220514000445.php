    ...
    <div id="uploader">
        ...
        <form action="upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                <input class="input-group-text" type="file" name="fichier" id="uploader">
                <button class="btnn btn-primary" type="submit">Uploader</button>            </div>
           <button class="btnn btn-primary" type="submit">Uploader</button>
        </form>
