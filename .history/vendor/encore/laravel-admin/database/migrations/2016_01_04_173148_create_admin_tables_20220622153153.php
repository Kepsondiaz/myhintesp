...
class CreateAdminTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create(config('admin.database.tmp_file_table'), function(Blueprint $table)
        {
            $table->increments('id');
            $table->string('tmp_url_file');
            $table->timestamps(); 
        });
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists(config('admin.database.tmp_file_table'));
    }
}
