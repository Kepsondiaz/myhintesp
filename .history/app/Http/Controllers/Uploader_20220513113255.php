    ...
    public function index(Request $request)
    {
               ...
               if (request()->hasFile('fichier')) 
               {
                    ...
                    // conndition pour uploader un fichier
                     if(($extenFileUpload == 'pdf' || $extenFileUpload == 'PDF' || $extenFileUpload == 'word' || $extenFileUpload == 'WORD' || $extenFileUpload == 'zip' || $extenFileUpload == 'ZIP') && $sizeFileUpload )
                    {
                         $path = $request->fichier->store('myhintesp_public_doc');<= 300000
